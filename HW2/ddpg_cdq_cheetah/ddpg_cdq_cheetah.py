...
class DDPG(object):
    ...
    def save_model(self, env_name, suffix="", actor_path=None, critic_path=None):
        ...
        if actor_path is None:
            actor_path = "preTrained/ddpg_cdq_cheetah_actor_{}_{}_{}".format(env_name, timestamp, suffix) 
        if critic_path is None:
            critic_path = "preTrained/ddpg_cdq_cheetah_critic_{}_{}_{}".format(env_name, timestamp, suffix) 
...
def train():    
    ...
    writer = SummaryWriter('./runs/ddpg_cdq_cheetah')
